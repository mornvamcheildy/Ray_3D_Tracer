...
public:
    ...
    double get_h() const { return coord_3d[0]; }
    double get_v() const { return coord_3d[1]; }
    double get_d() const { return coord_3d[2]; }
...
// NEW: Color Mixing (Hadamard Product) - Essential for materials reflecting light
inline Vec3 operator*(const Vec3 &u, const Vec3 &v) { return Vec3(u.coord_3d[0] * v.coord_3d[0], u.coord_3d[1] * v.coord_3d[1], u.coord_3d[2] * v.coord_3d[2]); }
...
{
    return Vec3(u.coord_3d[1] * v.coord_3d[2] - u.coord_3d[2] * v.coord_3d[1],
                u.coord_3d[2] * v.coord_3d[0] - u.coord_3d[0] * v.coord_3d[2],
                u.coord_3d[0] * v.coord_3d[1] - u.coord_3d[1] * v.coord_3d[0]);
}

inline Vec3 unit_vector(Vec3 v) { return (1.0 / v.length()) * v; }
